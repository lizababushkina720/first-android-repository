...
import com.example.hw_01_sem2.ui.screen.about.AboutAppDialog
...
fun SearchScreen(
    ...
    aboutViewModel: AboutAppViewModel,
            ...
            Box(
                ...
                when (val state = uiState) {
                    ...
                    is SearchUiState.Success -> {
                        val organizations = state.organizations.items
    ...
    val showAboutDialog by aboutViewModel.showDialog.collectAsState()


    if (showAboutDialog) {
        AboutAppDialog(viewModel = aboutViewModel)
    }
}
